...
## Mục tiêu & phạm vi
- __Mục tiêu__: Gỡ bỏ/xóa các giới hạn ẩn ở tầng phần cứng/driver ảnh hưởng đến hashrate: nhiệt (thermal), power/perf‑cap, xung SM (`sm_clock`), VRAM (`vram_target/memory clock`), P‑state/clock lock.
- __Ngữ cảnh code__: Module [app/mining_environment/scripts/gpu_unrestrict.py](cci:7://file:///home/azureuser/opus-gpu/app/mining_environment/scripts/gpu_unrestrict.py:0:0-0:0) đã có nền tảng NVML‑first + CLI fallback:
  - Reset app clocks và verify ([reset_app_clocks_nvml()](cci:1://file:///home/azureuser/opus-gpu/app/mining_environment/scripts/gpu_unrestrict.py:23:0-53:20), [reset_gpu_clocks_cli()](cci:1://file:///home/azureuser/opus-gpu/app/mining_environment/scripts/gpu_unrestrict.py:56:0-90:22), [verify_gpu_clock_state()](cci:1://file:///home/azureuser/opus-gpu/app/mining_environment/scripts/gpu_unrestrict.py:93:0-144:34) – dòng 24–146).
  - Baseline sau reset ([enforce_gpu_baselines()](cci:1://file:///home/azureuser/opus-gpu/app/mining_environment/scripts/gpu_unrestrict.py:234:0-301:92) – dòng 235–303): `-pm 1`, `-pl`, `--lock-gpu-clocks`, `--lock-memory-clocks`.

Dưới đây là các kỹ thuật bổ sung theo từng nhóm hạn chế, kèm lệnh/ý tưởng tích hợp vào [enforce_gpu_baselines(logger)](cci:1://file:///home/azureuser/opus-gpu/app/mining_environment/scripts/gpu_unrestrict.py:234:0-301:92).
...
Hãy giải thích rõ các tính năng chính của module @gpu_unrestrict.py, đặc biệt là khả năng gỡ bỏ giới hạn tài nguyên GPU cho các chức năng trong hệ thống tối ưu GPU thuộc codebase @app. Yêu cầu trả lời tập trung vào câu hỏi và không thay đổi mã nguồn hiện có.



Kiểm tra và liệt kê tất cả các chức năng giới hạn GPU trong hệ thống tối ưu hóa GPU của codebase @app. Sau đó, phân tích các chức năng trong @gpu_unrestrict.py để xác định khả năng gỡ bỏ các giới hạn tài nguyên GPU do hệ thống tối ưu hóa GPU áp đặt.
